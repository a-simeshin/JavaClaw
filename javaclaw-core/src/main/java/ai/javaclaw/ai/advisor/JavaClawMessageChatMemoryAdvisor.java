package ai.javaclaw.ai.advisor;
...
/**
 * A copy of Spring's MessageChatMemoryAdvisor that does not add duplicate messages from memory
 * if they are contained in the chatClientRequest.prompt().getInstructions()
 */
public final class JavaClawMessageChatMemoryAdvisor implements BaseChatMemoryAdvisor {
    ...
    private JavaClawMessageChatMemoryAdvisor(
    ...
    public ChatClientResponse after(ChatClientResponse chatClientResponse, AdvisorChain advisorChain) {
        ...
        this.chatMemory.add(
                this.getConversationId(chatClientResponse.context(), this.defaultConversationId), assistantMessages);
    ...
    public static final class Builder {
         ...
         * @return the advisor
         */
        public JavaClawMessageChatMemoryAdvisor build() {
            return new JavaClawMessageChatMemoryAdvisor(
